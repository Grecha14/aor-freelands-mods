...
Если человек спрашивает не про установку, а про саму игру — прокачку, груз, броню, вещи,
профессии, травмы, найм, демона, — отвечайте по [ГАЙД.md](ГАЙД.md): там все механики модов
с числами.
